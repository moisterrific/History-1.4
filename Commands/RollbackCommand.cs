...
namespace History.Commands
{
	public class RollbackCommand : HCommand
	{
		...
		public RollbackCommand(string account, int time, int radius, TSPlayer sender, string timeString, bool reenact = false)
			: base(sender)
		{
		...
		public override void Execute()
		{
			...
			int plrX = sender == null ? x : sender.TileX;
			int plrY = sender == null ? y : sender.TileY;
